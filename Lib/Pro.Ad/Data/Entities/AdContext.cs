...
namespace ProAd.Data.Entities
{
    ...
    public class AdContext 
    {
        ...
        public static IDictionary<string,string> ListAdPermsItem(int userId)
        {
            using (var db = DbContext.Get<DbSystem>())
            {
                return db.ExecuteDictionary<string>("ItemName", "Perms", "sp_Ad_Perms_User", "UserId", userId);
                //return db.ExecuteList.ExecuteList<AdPermsItem>("sp_Ad_Perms_User", "UserId", userId);
            }
        }
    }
    ...
    [EntityMapping("Ad", "vw_Ad", ProcListView = "sp_Ad_Perms_User")]
    public class AdPermsItem : IEntityItem
    {
