...
namespace Nistec.Services
{
    ...
    public class Settings
    {
        ...
        public const string ServiceName = "Nistec.Agent";
        public const string DisplayName = "Nistec";
        public const string ServiceDescription = "Nistec Remote Agent";
        ...
        public const string ServiceProcess = "Nistec.Agent.exe";
        public const string WindowsAppProcess = "Nistec.Server.exe";
