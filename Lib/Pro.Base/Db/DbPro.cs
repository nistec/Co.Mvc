...
namespace Pro.Data
{
    ...
    [Serializable]
    public class ProLocalizer : EntityLocalizer
    {
    ...
    [DbContext("cnn_pro")]
    [Serializable]
    public partial class DbPro : DbContext
    {
        #region static
        ...
        public static void DbRefresh(string entity, int AccountId)
        {
            using (var db = DbContext.Create<DbPro>())
            {
                //Lists.GetListsType(entity)
                db.ExecuteNonQuery("sp_Entity_Refresh", "Entity", entity, "AccountId", AccountId);
            }
        }
     ...
     {
         #region static
         public static void DbRefresh(int AccountId)
         {
