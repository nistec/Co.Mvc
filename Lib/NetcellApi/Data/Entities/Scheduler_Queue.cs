...
namespace Netcell.Data.Entities
{
    ...
    public class Scheduler_Queue_Context : EntityContext<Scheduler_Queue>
    {
        ...
        public static int DeCompleted(Guid QueueId)
        {
            using (var cmd = NetcellDB.Instance)
            {
                return cmd.ExecuteNonQuery("sp_Scheduler_DeCompleted", "QueueId", QueueId);
            }
        }
        public static int DeCompleted(Guid QueueId, int State)
        {
            using (var cmd = NetcellDB.Instance)
            {
                return cmd.ExecuteCommandNonQuery("sp_Scheduler_DeCompleted", DataParameter.Get("QueueId", QueueId, "State", State), CommandType.StoredProcedure);
            }
        }
        ...
        {
            return NetSerializer.DeserializeFromBase64<Scheduler_Queue>(base64);
        }
        ...
        public static int RemoveItem(Guid queueId, bool removePending)
        {
            ...
            using (var cmd = NetcellDB.Instance)
            {
                return cmd.ExecuteNonQuery("sp_Scheduler_Item_Update_b", "QueueId", queueId, "ActionType", actionType);
            }
        }
        ...
        public static int ChangeTime(Guid queueId, DateTime time)
        {
            ...
            using (var cmd = NetcellDB.Instance)
            {
                return cmd.ExecuteNonQuery("sp_Scheduler_Item_Update_b", "QueueId", queueId, "ActionType", actionType, "BatchTime", time);
            }
        }
