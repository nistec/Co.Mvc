...
namespace Netcell.Remoting
{
    ...
    public class CreditStatus
    {
        ...
        //{
        //    ActualCredit = MControl.Types.ToDecimal(dr["Credit"], 0);
        //    Cost = MControl.Types.ToDecimal(dr["Cost"], 0);
        //    CreditState = MControl.Types.ToInt(dr["CreditStatus"], 0);
        //    Count = units;
        //}
    ...
    /// </summary>
    public class ActiveCredit : ActiveEntity
    {
        ...
        public ActiveCredit(int accountId)
        {
            ...
            try
            {
                using (var dal = DalAccounts.Instance)
                {
                    dr=dal.AccountCredit(accountId);
                }
