...
namespace Netcell
{
    ...
    public class MsgMethod
    {
        ...
        {
           return EnumExtension.Parse<PlatformType>(platform, PlatformType.NA);
        }
        ...
        public static bool IsMultimedia(MethodType method)
        {
            return method == MethodType.SMSWP || method== MethodType.MALMT;
        }
