...
namespace Netcell.Data
{
    ...
    public class TargetEntity: IEntityItem
    {
        ...
        {
            return MControl.Runtime.Serialization.SerializeToJson(this);
        }

        public static TargetEntity Deserialize(string target)
        {
            return MControl.Runtime.Serialization.DeserializeFromJson<TargetEntity>(target);
        }

        public static string SerializeList(List<TargetEntity> list)
        {
            return MControl.Runtime.Serialization.SerializeToJsonArray<TargetEntity>(list);
        }

        public static List<TargetEntity> DeserializeList(string targets)
        {
            return MControl.Runtime.Serialization.DeserializeFromJsonArray<TargetEntity>(targets);
        }
