...
namespace Netcell.Data.Db.Entities
{
    ...
    public class CampaignEntity_Context : EntityContext<CampaignEntity>
    {
        ...
        //public static List<CampaignEntity> GetListItems(int itemId)
        //{
        //    using (Campaigns_Context context = new Campaigns_Context())
        //    {
        //        return context.EntityList(DataFilter.Get("CampaignId=@CampaignId", itemId));
        //    }
        //}
        ...
        //    using (IDbCmd cmd = NetcellDB.Instance.NewCmd())
        //    {
        //        return cmd.ExecuteCommand<DataTable>("select * from CampaignEntity where ItemId=@ItemId", DataParameter.Get("ItemId", itemId));
        //    }
        //}
        #endregion
        ...
        public static int Lookup_Method(int CampaignId)
        {
            ...
            {
                return cmd.LookupQuery<int>("MtId", "Campaigns", "CampaignId=@CampaignId", 0, new object[] { CampaignId });
            }
        }
    ...
    public class CampaignEntity : ICampaignEntity
    {
        ...
        {
            return Nistec.Strings.IntTimeToString(ValidTimeBegin);
        }
        public string GetValidTimeEnd()
        {
            return Nistec.Strings.IntTimeToString(ValidTimeEnd);
        }
        #endregion
    }
