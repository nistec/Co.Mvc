...
namespace Netcell.Data.Client
{
    ...
    public class DalCampaign : DbCommand
    {
        ...
        //[DBCommand("SELECT * from [Accounts_Features] where AccountId=@AccountId")]
        //public DataRow Accounts_Features_Mail(int AccountId)
        //{
        //    return (DataRow)base.Execute(new object[] { AccountId });
        //}

        //[DBCommand("SELECT EnableMobileRemove,EnableMobileSentBy,MobileRemoveText from [Accounts_Features] where AccountId=@AccountId")]
        //public DataRow Accounts_Features_Mobile(int AccountId)
        //{
        //    return (DataRow)base.Execute(new object[] { AccountId });
        //}

        /*
        [Obsolete("use View_MailShow insted")]
        [DBCommand(DBCommandType.StoredProcedure, "sp_Campaign_Mail_Show")]
        public DataRow Campaign_Mail_Show(int SentId, int Version, string DeviceName)
        {
            return (DataRow)base.Execute(new object[] { SentId, Version, DeviceName });
        }


        [Obsolete("use sp_Campaign_View_Preview insted")]
        [DBCommand(DBCommandType.StoredProcedure, "sp_Campaign_Preview")]
        public DataRow Campaign_Preview(int CampaignId, int MessageId)
        {
            return (DataRow)base.Execute(new object[] { CampaignId, MessageId });
        }
        */
        ...
        /*
        [DBCommand(DBCommandType.Insert, "Campaigns_Batch")]
        public int Campaigns_Batch_Add
            (
            [DbField(DalParamType.Key)] int CampaignId, 
            [DbField(DalParamType.Key)] int BatchId,
            [DbField] int BatchCount,
        ...
        {
            return (int)base.Execute(new object[] { CampaignId, BatchId, BatchCount, BatchStatus, BatchTime, BatchIndex, BatchRange, BatchType, UserId, Server });
        }
        */

        //[DBCommand(DBCommandType.Delete, "Campaigns_Batch")]
        //public int Campaigns_Batch_Delete
        //    (
        //    [DbField(DalParamType.Key)] int CampaignId,
        //    [DbField(DalParamType.Key)] int BatchId
        //    )
        ...
        //}
        //[DBCommand(DBCommandType.Update, "Campaigns_Batch")]
        //public int Campaigns_Batch_Update
        //    (
        //    [DbField(DalParamType.Key)] int CampaignId,
        //    [DbField(DalParamType.Key)] int BatchId,
        //    [DbField()] DateTime BatchTime
        //    )
        //{
        //    return (int)base.Execute(new object[] { CampaignId, BatchId, BatchTime });
        //}
        ...
        //[DBCommand("SELECT * from [Campaigns_Draft] where CampaignId=@CampaignId")]
        //public DataTable Campaigns_Draft(int CampaignId)
        //{
        //    return (DataTable)base.Execute(new object[] { CampaignId });
        //}

        //[DBCommand(DBCommandType.Delete, "Campaigns_Draft")]
        //public int Campaigns_Draft_Delete
        //    (
        //    [DbField(DalParamType.Key)] int CampaignId
        //    )
        //{
        ...
        //[DBCommand(0, "SELECT * from [Campaigns_Draft] where CampaignId=-1", null, MissingSchemaAction.AddWithKey)]
        //public DataTable Campaigns_Draft_Schema()
        //{
        //    return (DataTable)base.Execute();
        //}

        //[DBCommand(DBCommandType.StoredProcedure, "sp_Campaign_Draft_Delete")]
        //public int Campaigns_Draft_Delete
        //    (
        //    [DbField(DalParamType.Key)] int CampaignId
        //    )
        ...
        //[DBCommand(DBCommandType.Update, "Campaigns_Html")]
        //public int Campaigns_Html_Update([DbField(DalParamType.Key)] int CampaignId, [DbField] string Body)
        //{
        //    return (int)base.Execute(new object[] { CampaignId, Body });
        //}
        ...
        //[Obsolete("see new version"), DBCommand("SELECT * from [Campaigns_Content] where CampaignId=@CampaignId and ItemType=4")]
        //public DataRow Campaigns_Items_Barcode(int CampaignId)
        //{
        //    return (DataRow)base.Execute(new object[] { CampaignId });
        //}

        //[DBCommand("SELECT * from [Campaigns_Items_Cell] where CampaignId=@CampaignId")]
        //public DataTable Campaigns_Items_Cell(int CampaignId)
        //{
        //    return (DataTable)base.Execute(new object[] { CampaignId });
        //}

        //[DBCommand("SELECT * from [Campaigns_Items_Cell] where CampaignId=@CampaignId and BatchId=@BatchId")]
        //public DataTable Campaigns_Items_Cell(int CampaignId, int BatchId)
        //{
        //    return (DataTable)base.Execute(new object[] { CampaignId, BatchId });
        //}

        //[DBCommand("SELECT * from [vw_Campaign_ItemsView_Cell] where MessageId=@MessageId")]
        //public DataRow Campaigns_Items_Cell_View(int MessageId)
        //{
        //    return (DataRow)base.Execute(new object[] { MessageId });
        //}

        //[DBCommand("SELECT * from [vw_Campaign_ItemsNotif_Cell] where MessageId=@MessageId")]
        //public DataRow Campaign_ItemsNotif_Cell(int MessageId)
        //{
        //    return (DataRow)base.Execute(new object[] { MessageId });
        //}
        //[DBCommand("Select * from Campaigns_Items_Draft where DraftId=@DraftId"), Obsolete("see new version")]
        //public DataTable Campaigns_Items_Draft(string DraftId)
        //{
        //    return (DataTable)base.Execute(new object[] { DraftId });
        //}

        //[Obsolete("see new version"), DBCommand(DBCommandType.Delete, "Campaigns_Items_Draft")]
        //public int Campaigns_Items_Draft_Clear([DbField(DalParamType.Key)] string DraftId)
        //{
        //    return (int)base.Execute(new object[] { DraftId });
        //}

        //[Obsolete("see new version"), DBCommand(DBCommandType.Delete, "Campaigns_Items_Draft")]
        //public int Campaigns_Items_Draft_Delete([DbField(DalParamType.Key)] string DraftId, [DbField(DalParamType.Key)] string ItemKey)
        //{
        //    return (int)base.Execute(new object[] { DraftId, ItemKey });
        //}

        //[DBCommand("Select ItemKey,Count(*) as TotalCount,min(Ext)as Ext from Campaigns_Items_Draft where DraftId=@DraftId Group By ItemKey"), Obsolete("see new version")]
        //public DataTable Campaigns_Items_Draft_Groups(string DraftId)
        //{
        //    return (DataTable)base.Execute(new object[] { DraftId });
        //}

        //[Obsolete("see new version"), DBCommand(DBCommandType.Insert, "Campaigns_Items_Draft")]
        //public void Campaigns_Items_Draft_Insert([DbField] string DraftId, [DbField] string ItemKey, [DbField] string CellNumber, [DbField] string Coupon, [DbField] string Personal, [DbField] string Sender, [DbField] string Ext)
        //{
        //    base.Execute(new object[] { DraftId, ItemKey, CellNumber, Coupon, Personal, Sender, Ext });
        //}

        //[DBCommand("SELECT * from [Campaigns_Items_Mail] where CampaignId=@CampaignId")]
        //public DataTable Campaigns_Items_Mail(int CampaignId)
        //{
        //    return (DataTable)base.Execute(new object[] { CampaignId });
        //}

        //[DBCommand("SELECT * from [Campaigns_Items_Mail] where CampaignId=@CampaignId and BatchId=@BatchId")]
        //public DataTable Campaigns_Items_Mail(int CampaignId, int BatchId)
        //{
        //    return (DataTable)base.Execute(new object[] { CampaignId, BatchId });
        //}

        //[DBCommand("SELECT * from [vw_Campaign_ItemsView_Mail] where MessageId=@MessageId")]
        //public DataRow Campaigns_Items_Mail_View(int MessageId)
        //{
        //    return (DataRow)base.Execute(new object[] { MessageId });
        //}

        //[DBCommand("SELECT * from [vw_Campaign_ItemsNotif_Mail] where MessageId=@MessageId")]
        //public DataRow Campaign_ItemsNotif_Mail(int MessageId)
        //{
        //    return (DataRow)base.Execute(new object[] { MessageId });
        //}
        ...
        //[DBCommand("SELECT * from [Campaigns_Items_Cell] where CampaignId=@CampaignId and MessageId=@MessageId")]
        //public DataTable Campaigns_Items_Scheduler(int CampaignId, int MessageId)
        //{
        //    return (DataTable)base.Execute(new object[] { CampaignId, MessageId });
        //}

        //[DBCommand(DBCommandType.StoredProcedure, "sp_Campaign_Items_ToSend")]
        //public DataTable Campaigns_Items_ToSend(int CampaignId, int BatchId)
        //{
        //    return (DataTable)base.Execute(new object[] { CampaignId, BatchId });
        //}

        //[DBCommand(DBCommandType.StoredProcedure, "sp_Campaign_Items_ToSend")]
        //public DataTable Campaigns_Items_ToSend(int CampaignId, int BatchId, int ProductType)
        //{
        //    return (DataTable)base.Execute(new object[] { CampaignId, BatchId, ProductType });
        //}
        ...
        //[Obsolete("use campaign_view insted")]
        //[DBCommand("Select top 1 * from Campaigns_Html where CampaignId=@CampaignId")]
        //public DataRow Campaigns_Mail_Html(int CampaignId)
        //{
        //    return (DataRow)base.Execute(new object[] { CampaignId });
        //}

        //[DBCommand("Select ContentKey,ContentName from Campaigns_Html where AccountId=@AccountId and State>0")]
        //public DataTable Campaigns_Mail_Html_List(int AccountId)
        //{
        ...
        //[DBCommand(DBCommandType.StoredProcedure, "sp_Campaign_Process_Insert")]
        //public void Campaigns_Process_Insert([DbField] int CampaignId, [DbField] int BatchId, [DbField] int AccountId, [DbField] int Received, [DbField] int Canceled, [DbField] int Success, [DbField] int Delivered, [DbField] int Failed, [DbField] decimal Price, [DbField] int MtId, [DbField] byte Status, [DbField] int Units, [DbField] int UserId)
        //{
        //    base.Execute(new object[] { CampaignId, BatchId, AccountId, Received, Canceled, Success, Delivered, Failed, Price, MtId, Status, Units, UserId });
        //}
        ...
        /*
        [DBCommand("SELECT * from [Campaigns_RB] where CampaignId=@CampaignId")]
        public DataRow Campaigns_RB(int CampaignId)
        {
            return (DataRow)base.Execute(new object[] { CampaignId });
        }

        [DBCommand(DBCommandType.Insert, "Campaigns_RB")]
        public int Campaigns_RB_Insert([DbField] int CampaignId, [DbField] int ServiceId, [DbField] int DeviceRule, [DbField] int AppId, [DbField] int SignCount, [DbField] int MaxSession, [DbField] int Interval)
        {
            return (int)base.Execute(new object[] { CampaignId, ServiceId, DeviceRule, AppId, SignCount, MaxSession, Interval });
        }

        [DBCommand(DBCommandType.Update, "Campaigns_RB")]
        public int Campaigns_RB_Update
            (
            [DbField(DalParamType.Key)] int CampaignId,
            [DbField] int ServiceId, 
        ...
        [DBCommand("SELECT * from [vw_Campaigns_RB] where CampaignId=@CampaignId")]
        public DataRow Campaigns_RB_View(int CampaignId)
        {
            return (DataRow)base.Execute(new object[] { CampaignId });
        }
         */
        ...
        //[Obsolete("see Scheduler")]
        //public int Campaigns_Scheduler(int CampaignId, int ScheduleType, DateTime LifeTime_Start, DateTime LifeTime_End, string DaysInWeek, string ExecTime)
        //{
        //    string[] strArray = ExecTime.Split(new char[] { ':' });
        //    DateTime nextUse = Types.ToDateTime(LifeTime_Start.ToString("s").Substring(0, 10) + " " + ExecTime + ":00", LifeTime_Start);
        //    DateTime lastUse = nextUse.AddDays(-1.0);
        //    int currentStep = ((int)nextUse.DayOfWeek) + 1;
        //    return this.Campaigns_Scheduler_Insert(CampaignId, ScheduleType, LifeTime_Start, LifeTime_End, lastUse, nextUse, true, currentStep, 7, DaysInWeek, ExecTime, 120);
        //}
        ...
        //[Obsolete("see Scheduler"), DBCommand(DBCommandType.Update, "Campaigns_Scheduler")]
        //public int Campaigns_Scheduler_Update([DbField(DalParamType.Key)] int CampaignId, [DbField] int ScheduleType, [DbField] DateTime LifeTime_Start, [DbField] DateTime LifeTime_End, [DbField] DateTime LastUse, [DbField] DateTime NextUse, [DbField] bool Enabled, [DbField] int CurrentStep, [DbField] int MaxSteps, [DbField] string DaysInWeek, [DbField] string ExecTime, [DbField] int ExpirationDelta)
        //{
        //    return (int)base.Execute(new object[] { CampaignId, ScheduleType, LifeTime_Start, LifeTime_End, LastUse, NextUse, Enabled, CurrentStep, MaxSteps, DaysInWeek, ExecTime, ExpirationDelta });
        //}
       ...
       [DBCommand(DBCommandType.StoredProcedure, "sp_Campaigns_Delete_Draft")]
        ...
        //[DBCommand("SELECT * from [vw_Campaigns_Wap_Item]Id=@Id and FormId=@FormId Order By OrderId")]
        //public DataRow Campaigns_Wap_Item(int Id, int FormId)
        //{
        //    return (DataRow)base.Execute(new object[] { Id, FormId });
        //}
        ...
        //public bool Exists_Campaigns_Batch(int CampaignId, int BatchId)
        //{
        //   //return base.LookupQuery<int>("BatchId", "Campaigns_Batch", "CampaignId=@CampaignId and BatchId=@BatchId and BatchStatus=@BatchStatus",0, new object[] { CampaignId, BatchId, 0 })>0;
        //   return base.DExists("BatchId", "Campaigns_Batch", "CampaignId=@CampaignId and BatchId=@BatchId and BatchStatus=@BatchStatus", new object[] { CampaignId, BatchId, 0 });
        //}

        //public bool Exists_Schdeluer_Batch(int BatchId)
        //{
        //    return base.DExists("ArgId", "Scheduler_Queue", "ArgId=@BatchId and State=@State and DataSource=@DataSource", new object[] { BatchId, 0, "Batch" });
        //}
        ...
        //public string Lookup_Campaigns_Mail_Body(int CampaignId)
        //{
        //    return base.LookupQuery<string>("Body", "Campaigns_View", "CampaignId=@CampaignId", "", new object[] { CampaignId });
        //}

        //public string GetCampaigns_Mail_Html(int CampaignId)
        //{
        //    return base.Dlookup<string>("Body", "Campaigns_Html", "CampaignId=" + CampaignId.ToString(), "");
        //}

        //public int GetFirstItemId(int campaignId, bool isMail)
        //{
        //    if (isMail)
        //    {
        //        return base.DMin<int>("MessageId", "Campaigns_Items_Mail", "CampaignId=@CampaignId" , new object[]{ campaignId});
        //    }
        //    return base.DMin<int>("MessageId", "Campaigns_Items_Cell", "CampaignId=@CampaignId", new object[] { campaignId });
        //}
        ...
        //    )
        //{
        //    base.Execute(new object[] { CampaignId, Status });
        //}
