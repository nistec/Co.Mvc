...
namespace Netcell.Data.Client
{
    ...
    public class DalAccounts : Nistec.Data.SqlClient.DbCommand
    {
        ...
        //public DalAccounts(string instance)
        //    : base(Netcell.Data.DBRule.GetNetcellCnn(instance))
        //{

        //}

        //public static DalAccounts GetInstance(string instance)
        //{
        //    if (instance == null)
        //        return Instance;
        //    return new DalAccounts(instance); 
        //}
        ...
        public  DataTable Accounts_Type()
       {
        ...
        /*
        [DBCommand(DBCommandType.StoredProcedure, "sp_Accounts_Update")]
        public int Account_Update(
        [DbField(DalParamType.Key)]int AccountId,
        [DbField()]int ParentId,
        [DbField()] string AccountName,
        [DbField()] string ContactName,
        ...
        {
            return (int)base.Execute(AccountId,
         ParentId, AccountName, ContactName, Address, City, ZipCode, Phone, Fax, Mobile, Email,
         IdNumber, Country, OwnerId, AccType, BusinessGroup, IsHold, PayType, CreditBillingType,
         Details, IsActive, RepId, PriceCode, UsingType, DefaultSender);
        }

        [DBCommand(DBCommandType.Update, "Accounts")]
        public int Account_Update(
        [DbField(DalParamType.Key)]int AccountId,
            //[DbField()]int ParentId,
        [DbField()] string AccountName,
        ...
        {
            return (int)base.Execute(AccountId,
          AccountName, ContactName, Address, City, ZipCode, Phone, Fax, Mobile, Email,
          IdNumber, Country, BusinessGroup, Details, RepId, LastUpdate);
        }
       ...
       */
        ...
        //===========================================
         ...
         //public string GetDefaultSender(int AccountId)
         //{
        ...
        /*
         ...
         {
             return Account_Billing(ref BillingId,AccountId, CampaignId, TransId, CreditValue, DefaultPrice, 5, UserId, Remarks, Units, Platform);
         }


         [DBCommand(DBCommandType.StoredProcedure, "sp_Billing")]
         ...
         {
             object[] values = new object[] { BillingId,AccountId, CampaignId, TransId, CreditValue, DefaultPrice, ActionType, UserId, Remarks, Units, Platform };
        ...
        */
         ...
         )
         {
           ...
           //[DBCommand(DBCommandType.StoredProcedure, "sp_PricingCB_Update")]
           //public int PricingCB_Update(
           //    [DbField()]int AccountId,
           //    [DbField()]float SmsMT,
           //    [DbField()]float WapMT,
           //    [DbField()]float MalMT,
           //    [DbField()]int ParentPriceCode
           //   )
           //{
           //    return (int)base.Execute(AccountId, SmsMT, WapMT, MalMT, ParentPriceCode);
           //}

         /*
         public int ValidateCredit(int AccountId, string Method, int Units)
         {

             object o = base.ExecuteProcedure("sp_ValidateCredit", new SqlParameter[] { 
         ...
         public int ValidateCreditAndPrice(int AccountId, string Method, int Units, ref decimal Price)
         {
             SqlParameter parameter = new SqlParameter("DefaultPrice", SqlDbType.Float);
             parameter.Value = Price;
             parameter.Precision = 8;
             parameter.Scale = 4;
             parameter.Direction = ParameterDirection.Output;

             object o = base.ExecuteProcedure("sp_ValidateCreditAndPrice", new SqlParameter[] { 
                new SqlParameter("AccountId", AccountId),
                new SqlParameter("Method", Method),
                new SqlParameter("Units", Units) ,
                parameter
        ...
        */
         ...
         //[DBCommand("sp_Account_Price")]
         //public DataRow Accounts_Price(
         //[DbField()]int AccountId,
         //[DbField()]int MtId
         //)
         //{
         //    return (DataRow)base.Execute(AccountId, MtId);
         //}
        ...
        #region _Obsolete
         ...
         //[Obsolete("see ValidateCredit")]
         //[DBCommand(DBCommandType.StoredProcedure, "sp_CalcBillingPrice")]
         //public DataRow CalcBillingPrice(
         //    [DbField()]int AccountId,
         //    [DbField()]string Method,
         //    [DbField()]int Units
         //   )
         //{
         //    return (DataRow)base.Execute(AccountId, Method, Units);
         //}
