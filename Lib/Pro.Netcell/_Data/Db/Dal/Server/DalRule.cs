...
namespace Netcell.Data.Server
{
     public class DalRule : DbCommand
     {
        ...
        {
            return base.ExecuteCommand<DataRow>("select * from "+ tableName + " where " + where,DataParameter.GetSql(parameters));
        }
        ...
        {
            DataTable dt = base.ExecuteCommand<DataTable>("select [" + valueMember + "],[" + displayMember + "] from [" + tableName + "] where " + where, DataParameter.GetSql(parameters));
            if (dt == null)
                return null;
        ...
        #region credit
        //public int ValidateCredit(int AccountId, int Method, int Units)
        //{
        //    return base.ExecuteScalar<int>("sp_Credit_Validate", CommandType.StoredProcedure,0,0, new SqlParameter[] { new SqlParameter("AccountId", AccountId), new SqlParameter("MtId", Method), new SqlParameter("Units", Units) });
        //}

        //public int ValidateCredit(int AccountId, int Method, int Units, ref decimal Price)
        //{
        //    SqlParameter parameter = new SqlParameter("Price", SqlDbType.Float);
        //    parameter.Direction = ParameterDirection.Output;
        //    int res = base.ExecuteNonQuery("sp_Credit_Validate", CommandType.StoredProcedure, 0, new SqlParameter[] { new SqlParameter("AccountId", AccountId), new SqlParameter("MtId", Method), new SqlParameter("Units", Units), parameter });
        //    Price = Types.ToDecimal(parameter.Value, 0M);
        //    return res;// Types.ToInt(obj2, 0);
        //}

        //public int ValidateCredit(int AccountId, int Method, int Units, ref decimal Price, ref decimal Credit)
        //{
        //    SqlParameter parameter = new SqlParameter("Price", SqlDbType.Float);
        //    parameter.Direction = ParameterDirection.Output;
        //    SqlParameter parameter2 = new SqlParameter("Credit", SqlDbType.Float);
        //    parameter2.Direction = ParameterDirection.Output;
        //    int res = base.ExecuteNonQuery("sp_Credit_Validate", CommandType.StoredProcedure, 0, new SqlParameter[] { new SqlParameter("AccountId", AccountId), new SqlParameter("MtId", Method), new SqlParameter("Units", Units), parameter, parameter2 });
        //    Price = Types.ToDecimal(parameter.Value, 0M);
        ...
        public int ValidateCredit(int AccountId, int Method, int Units)
        {
            ...
            decimal Credit = 0M;
            int CreditStatus = 0;
            ValidateCredit(AccountId, Method, Units, 0, ref Price, ref Credit, ref CreditStatus);
