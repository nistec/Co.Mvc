...
namespace Pro.Netcell.Upload
{
    ...
    {
        //const string MappingName = "Contacts_Upload";
        //const string ProcName = "sp_Upload_Contacts";
        const string ProcUploadCatName = "sp_Upload_Contacts_Cat";
        ...
        public static string ContactKey(int accountId, string memberId)
        {
         ...
         public UploadSumarize Upload(DataTable dtCustomer, bool updateExists, ContactsUploadMethod method)
        {
            ...
            try
            {
                ...
                if (method == ContactsUploadMethod.Stg)
                {
                    ...
                    {
                        bulkCopy.BulkInsert(dtContacts, "Upload_STG", null);
                    }
                }
                else //if (method != ContactsUploadMethod.Preload)
                {
                    using (DbBulkCopy bulkCopy = new DbBulkCopy(Db))
                    {
                        bulkCopy.BulkInsert(dtContacts, "Upload_Contacts", null);
                    }
        ...
        internal int CreateUploadTables(DataTable dtFile, bool updateExists)//, ContactsUploadMethod method)
        {
            ...
            sumarize = new UploadSumarize();
            dtContacts = UploadMap.DbTableUploadSchema();
            ...
            foreach (DataRow row in dtFile.Rows)
            {
                try
                {
                    ...
                    string memberId = UploadReader.ReadTextField(row, "ContactId", null,15);
                    ...
                    key =  ContactKey(AccountId, memberId);
        ...
        */
        ...
        public static ContactsUploadSumarize ExecUploadContactCatProcedure(IDbContext db, int accountId, int category, string uploadKey, int updateExists)
        {
            
            ContactsUploadSumarize result = null;
            ...
            result = new ContactsUploadSumarize(parameters[4].Value);
            return result;
        ...
        public static int ExecDeleteContactsByCategory(IDbContext db, int AccountId, int Category)
        {
