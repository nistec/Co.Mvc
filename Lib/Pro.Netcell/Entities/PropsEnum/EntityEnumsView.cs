...
namespace ProNetcell.Data.Entities.PropsEnum
{
    ...
    public class CategoryView : EntityEnumView
    {
        ...
        {
            return db.EntityItemGet<CategoryView>(TableName, "PropId", PropId, "EnumType", EnumType, "AccountId", AccountId);
        }
    ...
    */
    ...
    public class RegionView : EntityEnumView
    {
        ...
        {
            return db.EntityItemGet<RegionView>(TableName, "PropId", PropId, "EnumType", EnumType, "AccountId", AccountId);
        }
