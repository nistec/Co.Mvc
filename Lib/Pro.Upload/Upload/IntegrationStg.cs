...
namespace Pro.Lib.Upload
{
    ...
    public class IntegrationStg : UploadFiles, IDisposable
    {
        ...
        public IntegrationStg(int accountId, IDbContext db, SourceTypes sourceType)
        {
            Db = db;
            AccountId = accountId;
        ...
        public static UploadSumarize DoUpload(IDbContext db, int AccountId, string fileName, bool updateExists, ContactsUploadMethod method= ContactsUploadMethod.Integration, SourceTypes sourceType= SourceTypes.Members)
        {
            try
            {
                DataTable dt = ReadFile(fileName);
                ...
                IntegrationStg stg = new IntegrationStg(AccountId, db, sourceType);
        ...
        int CreateUploadTableStg(DataTable dtFile)
        {
            ...
            {
                dtStg = db.QueryDataTable("select * from Integration_File_Stg where SourceType=@SourceType", SourceType, (int)SourceType);
            }
