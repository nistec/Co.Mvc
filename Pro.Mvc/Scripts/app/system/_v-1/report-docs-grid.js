            ...
            $("#jqxgrid").jqxGrid(
                {
                    ...
                    //filterable: true,
                    rowdetails: true,
                    rowdetailstemplate: { rowdetails: "<div style='margin: 10px;'><ul style='margin-right: 30px;'><li>תוכן</li><li class='title'></li><li>הערות</li><li>פעולות</li></ul><div class='body'></div><div class='information'></div><div class='comments'></div><div class='form'></div></div>", rowdetailsheight: 200 },
                    ...
                    columns: [
                         {
                            ...
                            cellsrenderer: function (row, columnfield, value, defaulthtml, columnproperties) {
                                ...
                                if (slf.UserId === asb)
                                    editlink = '<label> </label><a href="#" onclick="app_docs_grid.taskEdit(' + value + ')" ><label> </label><i class="fa fa-plus-square-o"></i></a>';


                                return '<div style="text-align:center;margin-top:6px">' + value + '<a href="#" onclick="app_docs_grid.taskInfo(' + value + ')" ><label> </label><i class="fa fa-info-circle"></i></a>' + editlink + '</div>';
                            }
                        },
                        {
                            text: 'סוג מסמך', dataField: 'TaskTypeName', cellsalign: 'right', align: 'center', width: 120,
                            filtertype: "custom",
        ...
        source:
            {
                ...
                hierarchy:
                {
                    keyDataField: { name: 'TaskId' },
                        parentDataField: { name: 'Task_Type' }
                },
                pagenum: 0,
                pagesize: 20
                //root: 'Rows',
        ...
        grid: function () {
            ...
            $("#jqxgrid").jqxTreeGrid(
            {
                ...
                //},
                    columns: [
                        {
                            text: 'סוג מסמך', dataField: 'Task_Type', cellsalign: 'right', align: 'center', 
                            filtertype: "custom",
                            createfilterpanel: function (datafield, filterPanel) {
                                app_jqxgrid.buildFilterPanel(filterPanel, datafield);
                            }
                        },
                  {
                        ...
                        cellsrenderer: function (row, columnfield, value, defaulthtml, columnproperties) {
                            return '<a href="#" onclick="app_docs_grid.taskInfo(' + value + ')" ><label> ' + value + ' </label><i class="fa fa-info-circle"></i></a>';
                        }
                  },
                  {
                      text: '  נושא  ', dataField: 'TaskSubject', cellsalign: 'right', align: 'center', width: subjectWidth,
                ...
                },
                {
                  ...
                  //{ text: 'משותף?', datafield: 'IsShare', threestatecheckbox: true, columntype: 'checkbox', width: 70 }
                    ...
                    //columnGroups: [
                    //    { text: 'TaskTypeName', name: 'TaskTypeName' }
                    //]
            });
            $("#jqxgrid").on("pagechanged", function (event) {
                var args = event.args;
