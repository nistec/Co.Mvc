...
var app_reminder = (function () {

    var app_reminder = function (dataModel, userInfo, taskModel) {
    ...
    app_reminder.prototype.taskSettings = function (record) {
    ...
    app_reminder.prototype.tabSettings = function () {
    ...
    app_reminder.prototype.doCancel = function () {
        app.redirectTo("/System/TaskUser");
         return this;
    }
  
    app_reminder.prototype.doSubmit = function (act) {
        //e.preventDefault();
        var slf = this;
        ...
        if (act == 'end')
            app_jqx.setInputAutoValue("#TaskStatus", 16);//$("#TaskStatus").val(16);
        else if (status == 0)
            app_jqx.setInputAutoValue("#TaskStatus", 1);//$("#TaskStatus").val(1);
        else if (this.TaskId > 0 && status == 1)
            app_jqx.setInputAutoValue("#TaskStatus", 2);//$("#TaskStatus").val(2);
    ...
    app_reminder.prototype.loadControls = function (record) {

        $('#DueDate').jqxDateTimeInput({ showCalendarButton: this.IsEditable, allowKeyboardDelete: false, width: '150px', rtl: true });
        $('#CreatedDate').jqxDateTimeInput({ showCalendarButton: false, allowKeyboardDelete: false, readonly: true, width: '150px', rtl: true });
        ...
        if (record) {
            ...
            var status = record ? record.TaskStatus : 1;
            //app_jqx_combo_async.taskStatusComboAdapter("#TaskStatus", status);
            app_jqx_combo_async.taskStatusInputAdapter("#TaskStatus", status);
            ...
            app_jqx_combo_async.taskStatusInputAdapter("#TaskStatus", 1);
            //app_jqx_combo_async.taskStatusComboAdapter("#TaskStatus", 1);
            app_jqx_adapter.createComboCheckAdapterAsync("UserId", "DisplayName", "#AssignTo", '/System/GetUsersList', null, 300, 0, null, null, function () {
    ...
    app_reminder.prototype.preLoad = function () {
    ...
    app_reminder.prototype.syncData_Obs = function (record) {
    ...
    app_reminder.prototype.loadControls_Obs = function (record) {
    ...
    app_reminder.prototype.lazyLoad = function (record) {
    ...
    app_reminder.prototype.loadEvents = function (record) {
    ...
    //app_task.prototype.syncData2 = function (record) {
    ...
    //app_task.prototype.loadEvents2 = function () {
    ...
    //app_task.prototype.loadControls2 = function (record) {
