    ...
    grid: function () {
        ...
        var initTaskAssignmentsGrid = function (tab, index, id) {
            ...
            var nastedsource = {
                datafields: [
                      ...
                      { name: 'EmployeeId_AssignedBy', type: 'number' },
                      { name: 'EmployeeId_AssignedTo', type: 'number' },
                ...
                id: 'AssignId',
                type: 'POST',
                url: '/System/GetTaskAssignmentList',
                data: { 'rcdid': id }
            }
        ...
        var initTaskCommentsGrid = function (tab, index, id) {
            ...
            nastedcontainer.jqxGrid({
                ...
                columns: [
                  ...
                  { text: 'שם', datafield: 'EmployeeName', width: 120, cellsalign: 'right', align: 'center' },
                  {
            ...
            .click(function () {
                slf.NScustomers.categoriesDialog = app_dialog.dialogIframe(app.appPath() + "/System/_TaskAssignAdd?id=" + id, "580", "400", "הערות");
            });
        ...
        var initrowdetails = function (index, parentElement, gridElement, datarecord) {
            ...
            if (tabsdiv != null) {
                ...
                //tab notes
                var notescontainer = $('<div style="white-space: normal; margin: 5px;text-align:right;"><span>' + datarecord.TaskBody + '</span></div>');
                ...
                var divLeft = $(
                    "<div style='margin: 10px;'><b>מטפל נוכחי:</b> " + (datarecord.EmployeeName || '') + "</div>" +
                ...
                var divRight = $("<div style='margin: 10px;'><b>מועד משוער להתחלה:</b> " + (datarecord.EstimateStartTime || '') + "</div>" +
                    ...
                    "<div style='margin: 10px;'><b>מועד התחלה:</b> " + (datarecord.StartedDate || '') + "</div>" +
                    "<div style='margin: 10px;'><b>מועד סיום:</b> " + (datarecord.EndedDate || '') + "</div>" +
        ...
        $("#jqxgrid").jqxGrid(
        {
            ...
            //filterable: true,
            rowdetails: true,
            rowdetailstemplate: { rowdetails: "<div style='margin: 10px;'><ul style='margin-right: 30px;'><li>תוכן</li><li class='title'></li><li>הערות</li><li>היסטוריה</li><li>זמנים</li></ul><div class='body'></div><div class='information'></div><div class='comments'></div><div class='history'></div><div class='timers'></div></div>", rowdetailsheight: 200 },
            ...
            columns: [
              {
                  text: 'קוד', dataField: 'TaskId', filterable: false, width: 100, cellsalign: 'right', align: 'center',
                    cellsrenderer: function (row, columnfield, value, defaulthtml, columnproperties) {
                       //var link = '<div style="text-align:center"><a href="#" onclick="memberEdit(' + value + ')" >הצג</a>';
                       //if (slf.AllowEdit == 1) {
                       //    var mid = $('#jqxgrid').jqxGrid('getrowdata', row).TaskId;
                       //    return link + ' | <a href="#" onclick="memberDelete(' + mid + ')" >הסר</a>';
                       //}
                       //else
                       //    return link + '</div>';
                       return '<div style="text-align:center"><a href="#" onclick="taskEdit(' + value + ')" >הצג</a></div>';
                   }
              },
              {
                text: 'נושא', dataField: 'TaskSubject', width: 160, cellsalign: 'right', align: 'center',
                  filtertype: "custom",
              ...
              {
                  text: 'סטאטוס', dataField: 'StatusName', cellsalign: 'right', align: 'center',
                  filtertype: "custom",
                  createfilterpanel: function (datafield, filterPanel) {
                      app_jqxgrid.buildFilterPanel(filterPanel, datafield);
                  }
            ...
            {
                text: 'מועד לביצוע', type: 'date', dataField: 'DueDate', cellsformat: 'd', cellsalign: 'right', align: 'center',
                filtertype: "custom",
                createfilterpanel: function (datafield, filterPanel) {
                    app_jqxgrid.buildFilterPanel(filterPanel, datafield);
                }
              ...
              {
                  text: 'מועד המשימה', type: 'date', dataField: 'CreatedDate', cellsformat: 'd', cellsalign: 'right', align: 'center',
                  filtertype: "custom",
                  createfilterpanel: function (datafield, filterPanel) {
                      app_jqxgrid.buildFilterPanel(filterPanel, datafield);
                  }
                ...
                {
                    text: 'מועד התחלה', type: 'date', dataField: 'StartedDate', cellsformat: 'd', cellsalign: 'right', align: 'center',hidden: true,
                    filtertype: "custom",
                    createfilterpanel: function (datafield, filterPanel) {
                        app_jqxgrid.buildFilterPanel(filterPanel, datafield);
                    }
                ...
                {
                    text: 'מועד סיום', type: 'date', dataField: 'EndedDate', cellsformat: 'd', cellsalign: 'right', align: 'center', hidden: true,
                    filtertype: "custom",
                    createfilterpanel: function (datafield, filterPanel) {
                        app_jqxgrid.buildFilterPanel(filterPanel, datafield);
                    }
                ...
                {
                    text: 'מועד התחלה משוער', type: 'date', dataField: 'EstimateStartTime', cellsformat: 'd', cellsalign: 'right', align: 'center', hidden: true,
                    filtertype: "custom",
                    createfilterpanel: function (datafield, filterPanel) {
                        app_jqxgrid.buildFilterPanel(filterPanel, datafield);
                    }
...
function app_tasks_assign_def(AssignId, userInfo) {
            ...
            if (isValid) {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.Status >= 0) {
                            if (slf.IsDialog) {
                                window.parent.triggerTaskCompleted(data.OutputId);
                                //$('#fcForm').reset();
                            }
                            else {
                                app.refresh();
