...
function app_task_form_template(Model,userInfo) {
    ...
    this.updateUrl = '/System/TaskFormTemplateUpdate';
    this.deleteUrl = '/System/TaskFormTemplateDelete';
    this.showMemmbersUrl = '/System/AdShowMembers';
    this.fieldId = 'PropId';
    this.RelUrl = '/System/TaskFormTemplateRel';
    ...
    this.createCoulmns = function () {
        ...
        var columns = [
           {
               text: 'קוד תבנית', datafield: 'PropId', width: 60, cellsalign: 'right', align: 'center',hidden:true
           ...
           { text: 'שם תבנית', datafield: 'PropName', cellsalign: 'right', align: 'center' },
    ...
    app_jqxgrid.loadEntityDataGrid (this, Model.data);
    ...
    this.nastedGridLoder = function (id, all) {
        ...
        if (all == false) {
            ...
            $("#jqxgrid2_Show").show();
            $("#liUsers").text("פעולות");
            $("#pHelp").text("להסרת פעולה, יש לסמן את הרשומה הרצויה");
        }
        else {
            ...
            $("#jqxgrid2_Show").hide();
            $("#liUsers").text("פעולות להוספה");
            $("#pHelp").text("להוספת פעולות, יש לסמן את המפעולות הרצויות וללחוץ על עדכון");
        }
    };
...
app_task_form_template.prototype.loadControls = function () {
    ...
    var input_rules = [
             { input: '#PropName', message: 'חובה לציין תבנית!', action: 'keyup, blur', rule: 'required' }
    ];
...
app_task_form_template.prototype.nastedGrid = function (id) {
