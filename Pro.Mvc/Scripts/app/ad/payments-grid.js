    ...
    grid: function () {
        ...
        var initrowdetails = function (index, parentElement, gridElement, datarecord) {
            ...
            if (tabsdiv != null) {
              ...
              var divLeft = $("<div style='margin: 10px;'><b>מספר רישום:</b> " + datarecord.SignupId + "</div>" +
                    "<div style='margin: 10px;'><b>מספר סידורי בחברת האשראי:</b> " + datarecord.TransIndex + "</div>" +
                    "<div style='margin: 10px;'><b>קוד אישור חברת האשראי:</b> " + datarecord.Response + "</div>" +
                    "<div style='margin: 10px;'><b>מועד תשלום:</b> " + datarecord.PayedDate.toLocaleDateString() + "</div>");
                ...
                var divRight = $("<div style='margin: 10px;'><b>טלפון:</b> " + datarecord.CellPhone + "</div>" +
                    ...
                    "<div style='margin: 10px;'><b>מספר תשלום סידורי:</b> " + datarecord.SignupOrder + "</div>" +
        ...
        $("#jqxgrid").jqxGrid(
        {
            ...
            columns: [
              {
                  text: 'מס-תשלום', dataField: 'PayId', cellsalign: 'right', align: 'center'
              },
             {
                 text: 'סכום', dataField: 'Payed', width: 100, cellsalign: 'right', align: 'center'
             },
             {
                 text: 'כמות', dataField: 'Qty', width: 100, cellsalign: 'right', align: 'center'
             },
            // {
            //     text: 'מס-משלם', dataField: 'SignupOrder', width: 100, cellsalign: 'right', align: 'center'
            // },
            //{
            //    text: 'מס-סידורי', dataField: 'TransIndex', width: 100, cellsalign: 'right', align: 'center'
            //},
              {
                  text: 'תוקף', dataField: 'ValidityMonth', cellsalign: 'right', align: 'center'
              },
             {
                 text: 'ת.ז', dataField: 'MemberId', width: 120, cellsalign: 'right', align: 'center'
              },
              {
              ...
              //},
              {
                  text: 'מועד רישום', type: 'date', dataField: 'SignupDate', cellsformat: 'd', cellsalign: 'right', align: 'center'
              
              },
              {
                  text: 'מועד תפוגה', type: 'date', dataField: 'ExpirationDate', cellsformat: 'd', cellsalign: 'right', align: 'center'
              
              },
              {
                  text: 'מועד תשלום', type: 'date', dataField: 'PayedDate', cellsformat: 'd', cellsalign: 'right', align: 'center'
              }
            ]
        });
    },
