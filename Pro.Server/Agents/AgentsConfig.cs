...
namespace Pro.Server.Agents
{
    ...
    {
        public const int DefaultIntervalSetting = 30000;
        ...
        public static int SchedulerInterval = 60000;
        public static int SchedulerMaxThread = 1;
        public static bool SchedulerEnabled = true;
        public static int SchedulerMaxConnection = 10;
        ...
        static AgentsConfig()
        {
            ...
            SchedulerMaxThread = Types.ToInt(settings["SchedulerMaxThread"], 1);
            SchedulerEnabled = Types.ToBool(settings["SchedulerEnabled"], true);
            SchedulerMaxConnection = Types.ToInt(settings["SchedulerMaxConnection"], 10);
